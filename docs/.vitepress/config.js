...
let title = "VS Code Dev Container for SAP HANA App development for Node.js 12.x";
let description = "VS Code Dev Container for SAP HANA App development (XSA and CF) for Node.js 12x";
let color = "#f42525";
...
module.exports = {
  lang: "en-US",
  title: "VS Code Dev Container for SAP HANA App development for Node.js 12.x",
  description:
    "VS Code Dev Container for SAP HANA App development for Node.js 12.x",
  base: "/vsc-sap-hana-mta-dev-env-node12x/",
  head: [
    // ["link", { rel: "icon", href: `/assets/favicon.ico` }],
    ["meta", { name: "theme-color", content: color }],
    ["meta", { prefix: ogprefix, property: "og:title", content: title }],
    ["meta", { prefix: ogprefix, property: "og:type", content: "article" }],
    ["meta", { prefix: ogprefix, property: "og:url", content: "https://draschke.github.io/vsc-sap-hana-mta-dev-env-node12x/" }],
    ...
    // 1 1200X627
    ["meta", { prefix: ogprefix, property: "og:image", content: "https://draschke.github.io/vsc-sap-hana-mta-dev-env-node12x/hiddensee_1200_627.jpg" }],    
    ["meta", { prefix: ogprefix, property: "og:image:width", content: "1200" }],
    ["meta", { prefix: ogprefix, property: "og:image:height", content: "627" }],    
    // 2 600x314
    ["meta", { prefix: ogprefix, property: "og:image", content: "https://draschke.github.io/vsc-sap-hana-mta-dev-env-node12x/hiddensee_600_314.jpg" }],
    ...
    ["meta", { name: "twitter:image", content: "https://draschke.github.io/vsc-sap-hana-mta-dev-env-node12x/hiddensee_1200_627.jpg" }],
    ["meta", { name: "description", content: description }],
    ["meta", { name: "keywords", content: "VS Container SAP Node.js 12.x, VS Dev Container SAP Node.js, VS Container SAP HANA Node.js, XSA, XS Client, CAP, HANA-CLI, Fiori, Docker, SAPUI5, Kubernetes, K8s, Kyma, BTP, CF" }],
    ["meta", { name: "author", content: author }],
    // name: "image" => heroImage: /path_600_314.jpg
    // ["meta", { name: "image", content: "https://draschke.github.io/vsc-sap-hana-mta-dev-env-node12x/hiddensee_1200_627.jpg" }],
  ...
  themeConfig: {
    repo: "draschke/vsc-sap-hana-mta-dev-env-node12x",
    docsDir: "docs",
    ...
    nav: [
      ...
      {
        text: "Release Notes",
        link: "https://github.com/draschke/vsc-sap-hana-mta-dev-env-node12x/releases",
      },
    ],
